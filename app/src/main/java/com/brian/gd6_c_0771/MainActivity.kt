...
import com.brian.gd6_c_0771.databinding.ActivityMainBinding
import com.brian.gd6_c_0771.noti.NotificationReceiver
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createNotificationChanel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            val descriptionText = "Notification Descirption"
